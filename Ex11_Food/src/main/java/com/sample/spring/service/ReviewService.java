...
public class ReviewService {
	...
	public void createReview(Long foodId, String content, Double score) {
		...
		ReviewEntity review = ReviewEntity.builder().foodId(foodId).content(content).score(score)
	...
	public ReviewDto getFoodReview(Long foodId, Pageable page) { //
		...
		return ReviewDto.builder().avgScore(avgScore).reviews(reviews.getContent()).page(ReviewDto.ReviewDtoPage
				.builder().offset(page.getPageNumber() * page.getPageSize()).limit(page.getPageSize()).build()).build();
	}
